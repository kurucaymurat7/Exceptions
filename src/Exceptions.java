   ...
   kod icin  Java erisilemez catch-blogu--> Compile Time Error verir.
	 	...
	 	1) Garbage Collector surekli memory'i kontrol eder. Silinmesi gereken herhangi bir data varsa
	 		...
	 		ne zaman calisacagina Java karar verir.
	 		 ...
	 		 - final : bir variable'a final keyword declare edilirse, o artık değiştirilemez ve o şekilde kullanılmalıdır.
	 		            final method override edilemez.
	 		            final class inherit edilemez.
	 		 - finally : try-catch bloklarında her halükarda çalışmasını istediğimiz kod satırları için kullanılır.
	 		 - finalize: Garbage collector'un çalışması için kullanılan method'dur.
